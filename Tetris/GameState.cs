...
namespace Tetris
{
    internal class GameState
    {
        ...
        {
            foreach (Position p in CurrentBlock.TilePositions()) if (!GameGrid.IsEmpty(p.Row, p.Column)) return false;
        ...
        {
            foreach (Position p in CurrentBlock.TilePositions()) GameGrid[p.Row, p.Column] = CurrentBlock.Id;
        ...
        public int BlockDropDistance()
        {
            ...
            foreach (Position p in CurrentBlock.TilePositions()) drop = Math.Min(drop, TileDropInstance(p));
